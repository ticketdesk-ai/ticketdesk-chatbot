...
function Hh({ chatbotId: e }) {
  ...
  return console.log(`widget loading: ${d}`, c), d === !0 || !c ? null : /* @__PURE__ */ y.jsxs(Xv.div, { children: [
